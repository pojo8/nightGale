...
class ChangePasswordModal extends Component {
  ...
  onUpdatePassword(){
    ...
    const oldPasswordStr = this.state.oldPassword;
    const newPasswordStr = this.state.newPassword;
    const confirmPasswordStr = this.state.confirmPassword;

    if( oldPasswordStr === newPasswordStr || oldPasswordStr === confirmPasswordStr){
    ...
    return (
      ...
      <Modal  {...this.props} centered modalTransition={{ timeout: 700 }} backdropTransition={{ timeout: 1300 }}>
        ...
        <FormGroup row>
                  ...
                  value = {oldPassword} onChange={this.onOldPasswordChanged}/>
                  </InputGroup>
                  </Col>
        </FormGroup>
        <FormGroup row>
