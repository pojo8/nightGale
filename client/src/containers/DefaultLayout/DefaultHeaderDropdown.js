...
class DefaultHeaderDropdown extends Component {
  ...
  dropNotif() {
    ...
    return (
      <Dropdown nav className="d-md-down-none" isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        <DropdownToggle nav>
          <i className="icon-clock"></i><Badge pill color="danger">{itemsCount}</Badge>
        </DropdownToggle>
        <DropdownMenu right>
          <DropdownItem header tag="div" className="text-center"><strong>You have {itemsCount} notif</strong></DropdownItem>
          ...
          <DropdownItem>
            <div className="text-uppercase mb-1">
              <small><b>Hours this month</b></small>
            </div>
          ...
          <DropdownItem>
            <div className="text-uppercase mb-1">
              <small><b>Hours over 6 Months</b></small>
            </div>
            <Progress className="progress-xs" color="danger" value={this.totalOver6months} />
            <small className="text-muted">{this.totalOver6months}h/256GB</small>
          </DropdownItem>
        </DropdownMenu>
      </Dropdown>
    );
  ...
  dropAccnt() {
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right>
          <DropdownItem header tag="div" className="text-center"><strong>accnt</strong></DropdownItem>
          <DropdownItem><i className="fa fa-bell-o"></i> Updates<Badge color="info">42</Badge></DropdownItem>
          <DropdownItem><i className="fa fa-envelope-o"></i> mssgs<Badge color="success">42</Badge></DropdownItem>
          ...
          <DropdownItem><i className="fa fa-shield"></i> Lock accnt</DropdownItem>
  ...
  dropMssgs() {
    ...
    return (
      <Dropdown nav className="d-md-down-none" isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right className="dropdown-menu-lg">
          <DropdownItem header tag="div"><strong>You have {itemsCount} mssgs</strong></DropdownItem>
          <DropdownItem href="#">
          ...
          <DropdownItem href="#" className="text-center"><strong>View all mssgs</strong></DropdownItem>
        </DropdownMenu>
      </Dropdown>
    );
  }
  ...
  render() {
    const { notif, accnts, tasks, mssgs } = this.props;
    return (
        notif ? this.dropNotif() :
          accnts ? this.dropAccnt() :
